...
- Check out our [Vulnerability Response Process](https://github.com/sevabit-project/Meta/blob/master/VULNERABILITY_RESPONSE_SEVABIT.md), encourages prompt disclosure of any Vulnerabilities

## Information

Sevabit is a private cryptocurrency based on Monero. Over the course of the coming months, the Sevabit project aims to offer an incenvised full node layer with a secondary p2p network that offers a private communications layer based on the Tox protocol.
...
### On Linux for Android (using docker):
        ...
        cd utils/build_scripts/ && docker build -f android32.Dockerfile -t sevabit-android .
        # Create container
        docker create -it --name sevabit-android sevabit-android bash
        # Get binaries
        docker cp sevabit-android:/opt/android/sevabit/build/release/bin .
...
Run with `valgrind /path/to/sevabitd`. It will be slow.
